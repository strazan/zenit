...
import zenit.filesystem.FileGUI;
...
public class FileController {
	...
	private FileGUI gui; //TODO Testing-gui for now, to be changes later
	 ...
	 */
	public FileController(FileGUI gui, File workspace) {
	...
	public void readFile(File file) {
		...
		//TODO Change to JavaFX-controller
		DefaultStyledDocument dsd = ClassHandler.readFile(file);
	 ...
	 * @param dsd The content to write to disk TODO Change to JavaFX-gui format
	 */
	public void writeFile(File file, DefaultStyledDocument dsd) {

		if (file != null && dsd != null) {
			boolean successfulSave = ClassHandler.saveFile(file, dsd); //Tries to save file
			
			if (successfulSave) {
				gui.openDialog("Save was successful", "Saved file", JOptionPane.PLAIN_MESSAGE);
			} else {
				gui.openDialog("Save was unsuccessful", "Save failed", JOptionPane.WARNING_MESSAGE);
			}
		}
	}
	...
	//Package methods
	//TODO Update to new file-tree system
